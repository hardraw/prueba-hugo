...
const VisualEditorContainer = _styled("div", {
  target: "evezps90",
...
const createSlateValue = rawValue => {
  ...
  const rawDocHasNodes = !_isEmpty(_get(rawDoc, 'nodes'));
...
export default class Editor extends React.Component {
  constructor(props) {
    ...
    _defineProperty(this, "handleBlockClick", (event, type) => {
      ...
      const _EditListConfigured$c = EditListConfigured.changes,
  ...
  shouldForcePropsValue(oldPropsValue, oldStateValue, newPropsValue, newStateValue) {
    return _uniq([oldPropsValue, oldStateValue, newStateValue]).length === 1 && oldPropsValue !== newPropsValue;
  }
  ...
  render() {
    ...
    return React.createElement(VisualEditorContainer, null, React.createElement(EditorControlBar, null, React.createElement(Toolbar, {
