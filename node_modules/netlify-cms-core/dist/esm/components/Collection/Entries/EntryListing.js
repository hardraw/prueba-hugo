...
export default class EntryListing extends React.Component {
  constructor() {
    ...
    _defineProperty(this, "renderCardsForSingleCollection", () => {
      ...
      return entries.map((entry, idx) => React.createElement(EntryCard, _extends({}, entryCardProps, {
        entry: entry,
        key: idx
      })));
    });
    ...
    _defineProperty(this, "renderCardsForMultipleCollections", () => {
      ...
      return entries.map((entry, idx) => {
        ...
        return React.createElement(EntryCard, _extends({}, entryCardProps, {
          key: idx
        }));
      });
    });
  ...
  render() {
    ...
    return React.createElement("div", null, React.createElement(CardsGrid, null, Map.isMap(collections) ? this.renderCardsForSingleCollection() : this.renderCardsForMultipleCollections(), React.createElement(Waypoint, {
