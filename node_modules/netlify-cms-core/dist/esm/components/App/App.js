...
const AppMainContainer = _styled("div", {
  target: "e1ghgnen0",
...
const ErrorCodeBlock = _styled("pre", {
  target: "e1ghgnen2",
...
class App extends React.Component {
  configError(config) {
    ...
    return React.createElement(ErrorContainer, null, React.createElement("h1", null, t('app.app.errorHeader')), React.createElement("div", null, React.createElement("strong", null, t('app.app.configErrors'), ":"), React.createElement(ErrorCodeBlock, null, config.get('error')), React.createElement("span", null, t('app.app.checkConfigYml'))));
  }
  ...
  authenticating() {
    ...
    if (backend == null) {
      return React.createElement("div", null, React.createElement("h1", null, t('app.app.waitingBackend')));
    }

    return React.createElement("div", null, React.createElement(Notifs, {
  ...
  render() {
    ...
    return React.createElement(React.Fragment, null, React.createElement(Notifs, {
      CustomComponent: Toast
    ...
    }), React.createElement(AppMainContainer, null, isFetching && React.createElement(TopBarProgress, null), React.createElement(Switch, null, React.createElement(Redirect, {
      exact: true,
      from: "/",
      to: defaultPath
      ...
      from: "/search/",
      to: defaultPath
    }), hasWorkflow ? React.createElement(Route, {
      path: "/workflow",
      component: Workflow
      ...
      render: props => React.createElement(Editor, _extends({}, props, {
        newRecord: true
      }))
    }), React.createElement(Route, {
      ...
      render: props => React.createElement(Collection, _extends({}, props, {
        isSearchResults: true
      }))
    }), React.createElement(Route, {
      component: NotFoundPage
    })), useMediaLibrary ? React.createElement(MediaLibrary, null) : null));
  }
