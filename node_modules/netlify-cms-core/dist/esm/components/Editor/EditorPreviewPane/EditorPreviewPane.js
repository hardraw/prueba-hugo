...
export default class PreviewPane extends React.Component {
  constructor() {
    ...
    _defineProperty(this, "getWidget", function (field, value, metadata, props) {
      ...
      return !widget.preview ? null : React.createElement(PreviewHOC, {
    ...
    _defineProperty(this, "widgetFor", function (name) {
      ...
      if (Object.keys(_this.inferedFields).indexOf(name) !== -1) {
        ...
        value = React.createElement("div", null, React.createElement("strong", null, field.get('label', field.get('name')), ":"), " ", value);
      }
    ...
    _defineProperty(this, "widgetsFor", name => {
      ...
      if (List.isList(value)) {
        return value.map(val => {
          const widgets = nestedFields && Map(nestedFields.map((f, i) => [f.get('name'), React.createElement("div", {
            key: i
  ...
  render() {
    ...
    if (!collection) {
      React.createElement(PreviewPaneFrame, {
        head: styleEls
      });
    }
...
`;
    return React.createElement(ErrorBoundary, null, React.createElement(PreviewPaneFrame, {
      head: styleEls,
      initialContent: initialContent
    }, React.createElement(EditorPreviewContent, {
      previewComponent,
      previewProps
    })));
  }
