...
describe('entryDraft reducer', () => {
  describe('DRAFT_CREATE_FROM_ENTRY', () => {
    it('should create draft from the entry', () => {
      expect(reducer(initialState, actions.createDraftFromEntry(fromJS(entry)))).toEqual(fromJS({
  ...
  describe('DRAFT_CREATE_EMPTY', () => {
    it('should create a new draft ', () => {
      expect(reducer(initialState, actions.emptyDraftCreated(fromJS(entry)))).toEqual(fromJS({
        entry: _objectSpread({}, entry, {
          newRecord: true
        }),
        mediaFiles: [],
  ...
  describe('DRAFT_CHANGE', () => {
    it.skip('should update the draft', () => {
      ...
      expect(reducer(initialState, actions.changeDraft(newEntry))).toEqual(fromJS({
        entry: _objectSpread({}, entry, {
          raw: 'updated'
        }),
        mediaFiles: [],
  ...
  describe('persisting', () => {
    ...
    it('should handle persisting request', () => {
      const newState = reducer(initialState, actions.entryPersisting(Map({
        name: 'posts'
      }), Map({
        slug: 'slug'
      })));
    ...
    it('should handle persisting success', () => {
      let newState = reducer(initialState, actions.entryPersisting(Map({
        name: 'posts'
      }), Map({
        slug: 'slug'
      })));
      newState = reducer(newState, actions.entryPersisted(Map({
        name: 'posts'
      }), Map({
        slug: 'slug'
      })));
    ...
    it('should handle persisting error', () => {
      ...
      newState = reducer(newState, actions.entryPersistFail(Map({
        name: 'posts'
      }), Map({
        slug: 'slug'
      }), 'Error message'));
