...
export const INFERABLE_FIELDS = {
  title: {
    ...
    defaultPreview: value => React.createElement("h1", null, value),
  ...
  shortTitle: {
    ...
    defaultPreview: value => React.createElement("h2", null, value),
    // eslint-disable-line react/display-name
  ...
  author: {
    ...
    defaultPreview: value => React.createElement("strong", null, value),
    // eslint-disable-line react/display-name
    fallbackToFirstField: false,
    showError: false
  },
