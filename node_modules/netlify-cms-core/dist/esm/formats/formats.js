...
export function resolveFormat(collectionOrEntity, entry) {
  ...
  const customDelimiter = List.isList(frontmatter_delimiter) ? frontmatter_delimiter.toArray() : frontmatter_delimiter; // If the format is specified in the collection, use that format.
