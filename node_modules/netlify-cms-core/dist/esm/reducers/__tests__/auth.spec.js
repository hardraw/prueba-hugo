...
describe('auth', () => {
  ...
  it('should handle an authentication request', () => {
    expect(auth(undefined, authenticating())).toEqual(Immutable.Map({
      isFetching: true
    }));
  });
  it('should handle authentication', () => {
    expect(auth(undefined, authenticate({
  ...
  it('should handle an authentication error', () => {
    expect(auth(undefined, authError(new Error('Bad credentials')))).toEqual(Immutable.Map({
