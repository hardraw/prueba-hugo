...
import { SEARCH_ENTRIES_REQUEST, SEARCH_ENTRIES_SUCCESS, QUERY_REQUEST, QUERY_SUCCESS, SEARCH_CLEAR } from "../actions/search";
let loadedEntries;
let response;
let page;
let searchTerm;
...
const entries = function entries() {
  ...
  switch (action.type) {
    ...
    case SEARCH_ENTRIES_SUCCESS:
      ...
      return state.withMutations(map => {
        const entryIds = List(loadedEntries.map(entry => ({
